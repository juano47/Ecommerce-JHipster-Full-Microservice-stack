...
```
$ docker image tag invoice juano47/invoice
$ docker push juano47/invoice
$ docker image tag notification juano47/notification
$ docker push juano47/notification
$ docker image tag store juano47/store
$ docker push juano47/store
```
